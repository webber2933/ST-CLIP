...
from STCLIP.config import cfg
from STCLIP.dataset import make_data_loader
from STCLIP.solver import make_lr_scheduler, make_optimizer
from STCLIP.engine.inference import inference
from STCLIP.engine.trainer import do_train
from STCLIP.modeling.detector import build_detection_model
from STCLIP.utils.checkpoint import ActionCheckpointer
from STCLIP.utils.comm import synchronize, get_rank
from STCLIP.utils.logger import setup_logger, setup_tblogger
from STCLIP.utils.random_seed import set_seed
# pytorch issuse #973
import resource
...
def train(cfg, local_rank, distributed, tblogger=None, transfer_weight=False, adjust_lr=False, skip_val=False,
    ...
    actionlist, actiondict, actiontoken = text_prompt(dateset_label=cfg.TRAIN_LABEL, clipbackbone='ViT-B/16', device=device)
    ...
    extra_checkpoint_data = checkpointer.load(None, model_weight_only=transfer_weight,
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="config_files/STCLIP.yaml",
        metavar="FILE",
    ...
    logger = setup_logger("STCLIP", output_dir, global_rank)
