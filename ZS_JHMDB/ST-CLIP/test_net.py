...
from STCLIP.utils.logger import setup_logger
#pytorch issuse #973
import resource
import time
...
def main():
    ...
    save_dir = ""
    logger = setup_logger("STCLIP", save_dir, get_rank())
    ...
    actionlist, actiondict, actiontoken = text_prompt(dateset_label=cfg.TEST_LABEL, clipbackbone='ViT-B/16', device=device)
