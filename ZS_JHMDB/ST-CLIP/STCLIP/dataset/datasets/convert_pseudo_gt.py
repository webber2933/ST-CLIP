...
res = pd.read_csv('/home/josmy/Code/STCLIP.data/output/resnet101_8x8f_denseserial/inference/ava_video_val_v2.2/result.csv', names=['id', 'timestamp', 'x1', 'x2', 'x3', 'x4', 'act', 'conf'])
...
for rows in tqdm(ann_df.itertuples(), total=iter_num, desc='Calculating  info'):
    ...
    if movie_name not in movie_infos:
        ...
        img_root = '/home/josmy/Code/STCLIP.data/AVA/keyframes/trainval'
